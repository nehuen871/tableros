export class ProductService {
    ...
    updateProducts(data={}){
        async function postData(url = '', data = {}) {
          ...
          postData('/tablerosroles/edit/', data)
            .then((data) => {
    ...
    deleteProducts(data={}){
        async function postData(url = '', data = {}) {
          ...
          postData('/tablerosroles/delete/', data)
            .then((data) => {
              console.log(data); // JSON data parsed by `data.json()` call
            });
    }
    getTablerosRoles(data={}){
      async function postData(url = '', data = {}) {
        ...
        let test = postData('/tablerosroles/gettablerosroles/', data)
          .then((data) => {
            console.log(data); // JSON data parsed by `data.json()` call
          });
          return test;
    ...
    insertProduct(data={}){
        async function postData(url = '', data = {}) {
          ...
          postData('/tablerosroles/insert/', data)
            .then((data) => {
              console.log(data); // JSON data parsed by `data.json()` call
            });
    }
